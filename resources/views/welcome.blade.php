...
<div class="container">
    <div class="content">
        ...
        <div class="title">
            <h1 style="color: white;">Chatbot Imunicare PT. Bio Farma</h1>
        </div>
    </div>
</div>
<script src='/js/widget.js'>
            var botmanWidget  = {
                ...
                introMessage : 'hallo saya jocasta silah kan ketikan "seputar pemesanan" untuk memeunculkan menu yang di inginkan  ',
                chatServer : 'chatbot/botman.php', 
                title: 'JOCASTA'
            };  
